...
- **387 typed async methods** covering the full MplusKASSA API surface — see [API.md](API.md) for the complete method index
- **Auto-generated** from the official WSDL URL — regenerate anytime the WSDL changes
- **Fully typed** — 293 enum types and 1383 interfaces, all derived from the WSDL
